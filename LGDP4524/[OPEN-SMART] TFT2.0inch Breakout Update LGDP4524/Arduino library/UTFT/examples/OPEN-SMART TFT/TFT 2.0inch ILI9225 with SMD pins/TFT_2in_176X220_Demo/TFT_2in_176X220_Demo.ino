...
#define LCD_RST A0 // LCD Reset pin goes to Analog 0, you can also connect it to reset pin of Arduino
UTFT tft(ILI9225,LCD_RS,LCD_WR,LCD_CS,LCD_RST);
//UTFT tft(ILI9225,LCD_RS,LCD_WR,LCD_CS);//if you connect LCD reset pin to reset pin of Arduino, you can uncomment this
